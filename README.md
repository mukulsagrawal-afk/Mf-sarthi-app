...
- The bundled official-only snapshot contains 289 underlying portfolios, 22,297 disclosed security rows and 329 mapped Direct/Regular/Growth/IDCW plan variants. All bundled imports carry the 31 August 2026 date. The app reports schemes without a verified August disclosure as unavailable instead of substituting older or third-party data.
